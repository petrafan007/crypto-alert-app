        ...
        for coin in coins:
            try:
                ...
                portfolio.append({
                    ...
                    "auto_sell_enabled": getattr(coin, 'auto_sell_enabled', False),
                    "auto_sell_volatility_pct": getattr(coin, 'auto_sell_volatility_pct', None),
                    "auto_sell_quote_currency": getattr(coin, 'auto_sell_quote_currency', 'USDT') or 'USDT',
                    "auto_sell_triggered_at": format_iso_utc(coin.auto_sell_triggered_at) if hasattr(coin, 'auto_sell_triggered_at') and coin.auto_sell_triggered_at else None,
                    "auto_sell_confirmation_started_at": format_iso_utc(getattr(coin, 'auto_sell_confirmation_started_at', None)),
                    "auto_buy_enabled": getattr(coin, 'auto_buy_enabled', False),
                    "auto_buy_volatility_pct": getattr(coin, 'auto_buy_volatility_pct', None),
                    "auto_buy_quote_currency": getattr(coin, 'auto_buy_quote_currency', 'USDT') or 'USDT',
                    "auto_buy_amount": getattr(coin, 'auto_buy_amount', None),
                    "auto_buy_triggered_at": format_iso_utc(coin.auto_buy_triggered_at) if hasattr(coin, 'auto_buy_triggered_at') and coin.auto_buy_triggered_at else None,
                    "auto_buy_confirmation_started_at": format_iso_utc(getattr(coin, 'auto_buy_confirmation_started_at', None)),
                ...
                try:
                    ...
                    portfolio.append({
                        ...
                        "auto_sell_volatility_pct": getattr(coin, 'auto_sell_volatility_pct', None),
                        "auto_sell_quote_currency": getattr(coin, 'auto_sell_quote_currency', 'USDT') or 'USDT',
                        "auto_sell_triggered_at": format_iso_utc(getattr(coin, 'auto_sell_triggered_at', None)),
                        "auto_sell_confirmation_started_at": format_iso_utc(getattr(coin, 'auto_sell_confirmation_started_at', None)),
                        "auto_buy_enabled": getattr(coin, 'auto_buy_enabled', False),
                        "auto_buy_volatility_pct": getattr(coin, 'auto_buy_volatility_pct', None),
                        "auto_buy_quote_currency": getattr(coin, 'auto_buy_quote_currency', 'USDT') or 'USDT',
                        "auto_buy_amount": getattr(coin, 'auto_buy_amount', None),
                        "auto_buy_triggered_at": format_iso_utc(getattr(coin, 'auto_buy_triggered_at', None)),
                        "auto_buy_confirmation_started_at": format_iso_utc(getattr(coin, 'auto_buy_confirmation_started_at', None)),
