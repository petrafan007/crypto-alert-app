        ...
        <div style={{
            ...
            <Section id="trading-center" icon={<FaChartLine />} title="Trading Center">
                ...
                <ul style={{ paddingLeft: '20px', marginBottom: '16px', lineHeight: '1.9' }}>
                    ...
                    <li><strong>Combined Orders</strong> — the top-level Orders destination combines Binance.US, Webull, and active app automation orders while preserving source and account labels. Filter either tab by source, account, symbol, product type, status, or time range without making another exchange request. Use the owning exchange (or disable the app trigger) to manage an open order.</li>
