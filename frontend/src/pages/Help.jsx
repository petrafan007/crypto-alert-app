        ...
        <div style={{
            ...
            <Section id="ai-analysis" icon={<FaRobot />} title="AI Analysis Page">
                ...
                <ul style={{ paddingLeft: '20px', marginBottom: '16px', lineHeight: '1.9' }}>
                    ...
                    <li><strong>Sentiment Chart</strong> — a pair-aware price line with Hold (H), Consider Buying (CB), Buy Immediately (BI), Consider Selling (CS), and Sell Immediately (SI) markers. Compact labels show the measured move while hover tooltips reveal the complete signal, timestamp, thesis, prices, and outcome. Its range selector defaults to 1 Month and supports 1D through ALL.</li>
                    ...
                    <li><strong>Sentiment Variable Settings</strong> — Settings provides independent Correct and Wrong percentage magnitudes for Buy Immediately, Consider Buying, Hold, Consider Selling, and Sell Immediately. Exact boundaries are decisive; every move between the two opposite-direction boundaries is Neutral and excluded from win rates.</li>
