        ...
        <div style={{
            ...
            <Section id="webull-openapi-setup" icon={<FaChartLine />} title="Webull OpenAPI Setup & Import">
                ...
                <ul style={{ paddingLeft: '20px', marginBottom: '16px', lineHeight: '1.8' }}>
                    ...
                    <li>For an Event Contract, choose a live Webull category, optionally filter by <strong>Duration / Frequency</strong>, and search contracts currently open for a new position using words from the title, condition, event, series, or symbol. The available frequency choices come from Webull's current Series catalog for that category. <strong>15 minutes</strong> is derived only for Webull series that explicitly identify that cadence, and <strong>Intraday</strong> combines those series with Webull's Hourly frequency. All meaningful search words may match across fields, and common forms such as <strong>Bitcoin fifteen minutes</strong>, <strong>BTC 15 min</strong>, and <strong>bitcoin 15m</strong> are treated consistently. Future and non-tradable contracts are excluded. The selector reports verified live contracts only, keeps valid results visible while it checks additional catalog rows, and explains when Webull has no live quotes or temporarily rate-limits a refresh. The ticket displays current Yes/No quotes, contract rules, provider trading status, and its applicable trading-hours guidance.</li>
