        ...
        <div style={{
            ...
            <Section id="webull-openapi-setup" icon={<FaChartLine />} title="Webull OpenAPI Setup & Import">
                ...
                <ul style={{ paddingLeft: '20px', marginBottom: '16px', lineHeight: '1.8' }}>
                    ...
                    <li>For an Event Contract, choose a live Webull category and search every current market in that category by title, condition, event/series name, or symbol. The selector shows the top ten contracts by live activity when the search is empty. The ticket displays current Yes/No quotes, contract rules, provider trading status, and its applicable trading-hours guidance; a contract marked Not Tradable cannot be submitted, and Liquidate Only permits only an exact owned position to be sold.</li>
