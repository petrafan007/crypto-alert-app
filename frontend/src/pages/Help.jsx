    ...
    return (
        <div style={{
            ...
            <Section id="trading-center" icon={<FaChartLine />} title="Trading Center">
                ...
                <ul style={{ paddingLeft: '20px', marginBottom: '16px', lineHeight: '1.9' }}>
                    <li><strong>Exchange-specific workspaces</strong> — Binance.US Trading is isolated to Binance.US balances, pairs, and orders. Webull Trading shows account-scoped imported Webull positions and Webull orders; open Webull orders can be cancelled only through their owning Webull account after six-digit 2FA confirmation.</li>
