        ...
        <div style={{
            ...
            <Section id="ai-analysis" icon={<FaRobot />} title="AI Analysis Page">
                ...
                <ul style={{ paddingLeft: '20px', marginBottom: '16px', lineHeight: '1.9' }}>
                    ...
                    <li><strong>Sentiment Chart</strong> — a pair-aware price line with Hold (H), Consider Buying (CB), Buy Immediately (BI), Consider Selling (CS), and Sell Immediately (SI) markers. Compact labels show the measured move while hover tooltips reveal the complete signal, timestamp, thesis, prices, and outcome. New users default to 3 Days, the selector supports 1D through ALL, and each selection is saved as that user's default.</li>
