  ...
  return (
    <div className="settings-page-container">
      <Modal 
        ...
        centered
        contentClassName={isLightMode ? 'bg-light text-dark' : 'bg-dark text-light'}
      >
        <Modal.Header closeButton closeVariant={isLightMode ? 'black' : 'white'} style={{ borderBottom: `1px solid ${isLightMode ? '#e2e8f0' : '#2d3748'}` }}>
          <Modal.Title style={{ color: isLightMode ? '#2d3748' : '#fff', fontSize: '1.25rem', fontWeight: 'bold' }}>
        ...
        <Modal.Footer style={{ borderTop: `1px solid ${isLightMode ? '#e2e8f0' : '#2d3748'}` }}>
          <Button 
            variant={isLightMode ? 'outline-secondary' : 'outline-light'} 
