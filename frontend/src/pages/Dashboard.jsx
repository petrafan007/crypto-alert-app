import { syntheticOrderTooltip } from '../utils/syntheticOrders.mjs';
  ...
  const generateOrderTooltipText = (coin, orders) => {
    ...
    if (orders && orders.length > 0) {
      const describeOrder = (order) => {
        if (['LADDER', 'TRAILING_STOP'].includes(order.type)) return syntheticOrderTooltip(order, coin?.symbol);
                              ...
                              return (
                                ...
                                >
                                  <div className="coin-symbol-container" style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', justifyContent: 'flex-start' }}>
                                    ...
                                    >
                                      {isExternal ? <WebullLogo size={18} /> : <SiBinance />}
                                    </span>
                                    <span
