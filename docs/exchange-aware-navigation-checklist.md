...
Status: **Automated acceptance criteria verified and corrected through v2.46.0. One user-authorized production canary remains explicitly outstanding (CHK037).**
...
- [x] CHK040 The in-app Help page provides a complete Webull setup and operation reference: production/sandbox credential and verification flow, enabled-account selection, read-only preview and import, default-account behavior, provider/account isolation, order/cancellation 2FA, and the Webull fractional-share/session constraints. [Implemented in v2.46.0]
...
9. [x] Add complete Webull setup, import, navigation, trading-safety, and troubleshooting instructions to the in-app Help page for v2.46.0.
