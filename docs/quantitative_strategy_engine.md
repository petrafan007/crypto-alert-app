...
## Remaining review items after v2.99.24
...
- Correct Event audit sampling, missing-value/status defaults, and unsupported model conclusions; render factual report tables deterministically. Include legacy performance aggregation: configuration scope, oldest-first sample limits, fill/settlement status checks and default-zero P&L need review.
