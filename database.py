...
def init_db(app=None):
    ...
    from models import Coin, WatchlistCoin, Notification, AIPrompt, DefaultAIPrompt, StakedCoin, StakingReward, AIConversation, AICache, AssetIconCache, AIAnalysisSchedule, PriceHistory, WebullAccountSnapshot, WebullActivity, WebullEventSettlement, WebullHistoricalOrder, WebullHolding, ExternalSentimentSignal, WebullTestAccount, WebullTestPosition, WebullTestOrder
